    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                darklogo.attr('src', 'img/logos/geosentry-logo-color-220.svg');
                innerlogo.attr('src', 'img/logos/geosentry-logo-color-390.svg');
            } 
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                darklogo.attr('src', 'img/logos/geosentry-logo-color-390svg');
                if ($window.width() >= 992) {
                    innerlogo.attr(
                      "src",
                      "img/logos/geosentry-logo-color-220.svg"
                    );
                }
            }
        });
